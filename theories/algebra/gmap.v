...
Proof.
  ...
  remember (map_to_list m) as l eqn:Heql.
  assert (map_to_list m ≡ₚ l) as Hl by by rewrite Heql.
  clear Heql. revert m Hl. induction l as [|kx l IH].
  - intros m ->%map_to_list_empty_inv_alt.
